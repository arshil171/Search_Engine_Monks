...
const FAQItem = ({ faq, isOpen, onToggle }) => {
  return (
    <div
      className={`group relative rounded border overflow-hidden transition-all duration-400 ease-in-out ${
        isOpen
    ...
    >
      ...
      <div className={`absolute h-[40px] inset-0 bg-gradient-to-r from-[#0E6A4A]/5 to-transparent opacity-0 transition-opacity duration-400 pointer-events-none ${isOpen ? "opacity-100" : "group-hover:opacity-100"}`} />
      ...
      >
        <div className="flex items-center gap-4 flex-grow">
          <div className={`w-10 h-10 rounded flex items-center justify-center shrink-0 transition-all duration-400 ${
        ...
        <div className={`shrink-0 w-10 h-10 rounded flex items-center justify-center transition-all duration-400 ${
          isOpen
